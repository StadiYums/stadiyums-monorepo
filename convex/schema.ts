...
export const orderValidator = v.object({
  ...
  // Milestone timestamps (HEX-65) — elapsed math is timezone-agnostic
  vendorAcceptedAt: v.optional(v.number()),
  preparationStartedAt: v.optional(v.number()),
  readyForPickupAt: v.optional(v.number()),
  runnerAssignedAt: v.optional(v.number()),
  arrivedAtVendorAt: v.optional(v.number()),
  pickedUpAt: v.optional(v.number()),
  arrivedAtSectionAt: v.optional(v.number()),
  vendorRejectedAt: v.optional(v.number()),
  canceledAt: v.optional(v.number()),
  vendorDelayReportedAt: v.optional(v.number()),
  vendorDelayReason: v.optional(v.string()),
  vendorDelayNoteId: v.optional(v.string()),
